...
describe('Handling a Portugese file', () => {
  const expectedFieldValues = [
    ...
    { code: '1005', description: 'Gender', value: 'Male' },
    { code: '1006', description: 'Usage days', value: '21/30 days (70%)' },
    { code: '1007', description: '>= 4 hours', value: '2 days (7%)' },
    { code: '1008', description: '< 4 hours', value: '19 days (63%)' },
    { code: '1009', description: 'Average usage (total days)', value: '2 hours 5 minutes' },
    { code: '1010', description: 'Average usage (days used)', value: '2 hours 58 minutes' },
    { code: '1011', description: 'Median usage (days used)', value: '2 hours 55 minutes' },
    ...
    { code: '1028', description: 'Apnoea Index - Obstructive', value: '1.4' },
    { code: '1029', description: 'Apnoea Index - Unknown', value: '0.4' },
    { code: '1030', description: 'Cheyne-Stokes respiration (average duration per night)', value: '20 minutes (12%)' },
    { code: '1031', description: 'SpO2% - Time<88%', value: '18 min' },
    { code: '1032', description: 'SpO2% - Median', value: '92' },
    { code: '1033', description: 'SpO2% - percentile 95', value: '96' },
  ];
...
describe('Handling a Spanish file', () => {
  const expectedFieldValues = [
    { code: '1001', description: 'Date', value: '03/10/2022 - 03/10/2022' },
    { code: '1002', description: 'Patient ID', value: '00402499934' },
    { code: '1003', description: 'DOB', value: '20/10/1960' },
    { code: '1004', description: 'Age', value: '61' },
    { code: '1005', description: 'Gender', value: 'Male' },
    { code: '1006', description: 'Usage days', value: '1/1 days (100%)' },
    { code: '1007', description: '>= 4 hours', value: '1 days (100%)' },
    { code: '1008', description: '< 4 hours', value: '0 days (0%)' },
    { code: '1009', description: 'Average usage (total days)', value: '6 hours 44 minutes' },
    { code: '1010', description: 'Average usage (days used)', value: '6 hours 44 minutes' },
    { code: '1011', description: 'Median usage (days used)', value: '6 hours 44 minutes' },
    { code: '1012', description: 'Serial number', value: '00402499934' },
    { code: '1013', description: 'Mode', value: 'AutoSet' },
    { code: '1014', description: 'Min Pressure', value: '5.2 cmH2O' },
    { code: '1015', description: 'Max Pressure', value: '20 cmH2O' },
    { code: '1016', description: 'EPR level', value: '3' },
    { code: '1017', description: 'Response', value: 'Suave' },
    { code: '1018', description: 'Pressure -cm H2O - median', value: '9.8' },
    { code: '1019', description: 'Pressure -cm H2O - percentile 95', value: '11.2' },
    { code: '1020', description: 'Pressure -cm H2O - max', value: '11.8' },
    { code: '1021', description: 'Leaks l/min - median', value: '0.0' },
    { code: '1022', description: 'Leaks l/min - percentile 95', value: '12.0' },
    { code: '1023', description: 'Leaks l/min - max', value: '24.0' },
    { code: '1024', description: 'Events per hour - AI', value: '10.3' },
    { code: '1025', description: 'Events per hour - HI', value: '0.0' },
    { code: '1026', description: 'Events per hour - AHI', value: '10.3' },
    { code: '1027', description: 'Apnoea Index - Central', value: '8.6' },
    { code: '1028', description: 'Apnoea Index - Obstructive', value: '1.3' },
    { code: '1029', description: 'Apnoea Index - Unknown', value: '0.4' },
    { code: '1030', description: 'Cheyne-Stokes respiration (average duration per night)', value: '20 minutes (5%)' },
    { code: '1031', description: 'SpO2% - Time<88%', value: '16 min' },
    { code: '1032', description: 'SpO2% - Median', value: '90' },
    { code: '1033', description: 'SpO2% - percentile 95', value: '95' },
  ];

  describe('Sending the file as part of multipart formdata', () => {
    const SAMPLE_PDF = path.join(__dirname, 'compliance-report-spanish.pdf');
